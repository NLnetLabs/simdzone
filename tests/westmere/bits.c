...
void test_westmere_trailing_zeroes(void **state)
{
  fprintf(stderr, "test_westmere_trailing_zeroes\n");
  (void)state;
...
void test_westmere_leading_zeroes(void **state)
{
  (void)state;
  fprintf(stderr, "test_westmere_leading_zeroes\n");
  for (uint64_t shift = 0; shift < 63; shift++) {
...
void test_westmere_prefix_xor(void **state)
{
  (void)state;
  fprintf(stderr, "test_westmere_prefix_xor\n");
...
void test_westmere_add_overflow(void **state)
{
  (void)state;
  fprintf(stderr, "test_westmere_add_overflow\n");
